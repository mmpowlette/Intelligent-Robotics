...
if clientID!=-1:
  ...
  res, v0 = sim.simxGetObjectHandle(clientID, '/NAO/vision[0]', sim.simx_opmode_oneshot_wait)
  res, v1 = sim.simxGetObjectHandle(clientID, '/NAO/vision[1]', sim.simx_opmode_oneshot_wait)
